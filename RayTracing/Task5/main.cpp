//Ray Tracing project Task 5 Refraction
...
void render(const int & x_dimension, const int & y_dimension, Camera camera, hittable_list world){
    ...
    output.open("./project5.ppm", std::ios::out | std::ios::trunc);
...
int main() {
    ...
    world.add(make_shared<Sphere>(glm::dvec3( 0.45,    -0.085, -1.0),   0.2, material_right1));
    world.add(make_shared<Sphere>(glm::dvec3(-0.85,    -0.115, -1.0),   0.15, material_left2));
    world.add(make_shared<Sphere>(glm::dvec3( 0.85,    -0.115, -1.0),   0.15, material_right));
