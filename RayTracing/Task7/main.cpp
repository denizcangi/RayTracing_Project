...
hittable_list creative(){
    
    hittable_list objects;
    
    auto light = make_shared<diffuse_light>(glm::dvec3(1.5, 0.5, 0.75));
    auto glass=make_shared<dielectric>(1.5);
    
    auto metall = make_shared<metal>(glm::dvec3(0.7,0.1,0.7),0.2);
    auto metal2 = make_shared<metal>(glm::dvec3(0.73,0.73,0.73),0.8);
    auto metal3 = make_shared<metal>(glm::dvec3(0.8,0.1,0.1),0.0);
    auto metal4 = make_shared<metal>(glm::dvec3(0.7,0.1,0.7),1.0);
    
    objects.add(make_shared<yz_rect>(0, 555, 0, 555, 555, light));
    objects.add(make_shared<yz_rect>(0, 555, 0, 555, 0, light));
    objects.add(make_shared<xy_rect>(0, 555, 0, 555, -801, light));
    objects.add(make_shared<xy_rect>(0, 555, 0, 555, 555, metal4));
    objects.add(make_shared<xz_rect>(0, 555, 0, 555, 0, metal4));
    objects.add(make_shared<xz_rect>(0, 555, 0, 555, 555, metall));
    
    auto pertext = make_shared<noise_texture>(4.0);
    
    objects.add(make_shared<Sphere>(glm::dvec3(92.5,92.5,277.5), 92.5, make_shared<metal>(glm::dvec3(0.8, 0.8, 0.9), 1.0)));
    objects.add(make_shared<box>(glm::dvec3(0,185,185),glm::dvec3(185,370,370),make_shared<lambertian>(pertext)));
    
    objects.add(make_shared<Sphere>(glm::dvec3(462.5,92.5,277.5), 92.5, make_shared<metal>(glm::dvec3(0.8, 0.8, 0.9), 1.0)));
    objects.add(make_shared<box>(glm::dvec3(370,185,185),glm::dvec3(555,370,370),make_shared<lambertian>(pertext)));
    
    objects.add(make_shared<Sphere>(glm::dvec3(277.5,92.5,462.5), 92.5, make_shared<metal>(glm::dvec3(0.8, 0.8, 0.9), 1.0)));
    objects.add(make_shared<box>(glm::dvec3(185,185,370),glm::dvec3(370,370,555),make_shared<lambertian>(pertext)));
    
    objects.add(make_shared<Sphere>(glm::dvec3(92.5,462.5,277.5), -92.5, glass));
    objects.add(make_shared<Sphere>(glm::dvec3(277.5,462.5,462.5), -92.5, glass));
    objects.add(make_shared<Sphere>(glm::dvec3(462.5,462.5,277.5), -92.5, glass));
    
    return objects;
}

hittable_list new_creative(){
    hittable_list objects;

    auto blue   = make_shared<lambertian>(glm::dvec3(0.2, 0.4, 0.9));
    auto light = make_shared<diffuse_light>(glm::dvec3(1, 1, 1));
//    auto mini_light = make_shared<diffuse_light>(glm::dvec3(1,1,1));

    objects.add(make_shared<yz_rect>(0, 555, 0, 555, 555, blue));
    objects.add(make_shared<yz_rect>(0, 555, 0, 555, 0, blue));
    //    objects.add(make_shared<xz_rect>(213, 343, 227, 332, 554, light));
    objects.add(make_shared<xz_rect>(0, 555, 0, 555, 0, blue));
    objects.add(make_shared<xz_rect>(0, 555, 0, 555, 555, light));
    objects.add(make_shared<xy_rect>(0, 555, 0, 555, 555, blue));
    objects.add(make_shared<xy_rect>(0, 555, 0, 555, -801, light));
    
    auto pertext = make_shared<noise_texture>(1.0);
    auto letter_texture = make_shared<dielectric>(1.5);
    
//    gives letter D
    
    objects.add(make_shared<Sphere>(glm::dvec3(457.5,187.5,525), -30, letter_texture));
    objects.add(make_shared<Sphere>(glm::dvec3(457.5,247.5,525), -30, letter_texture));
    objects.add(make_shared<Sphere>(glm::dvec3(457.5,307.5,525), -30, letter_texture));
    objects.add(make_shared<Sphere>(glm::dvec3(457.5,367.5,525), -30, letter_texture));
    objects.add(make_shared<Sphere>(glm::dvec3(397.5,345,525), -30, letter_texture)); //337.5
    objects.add(make_shared<Sphere>(glm::dvec3(397.5,210,525), -30, letter_texture)); //217.5
    objects.add(make_shared<Sphere>(glm::dvec3(337.5,307.5,525), -30, letter_texture));
    objects.add(make_shared<Sphere>(glm::dvec3(337.5,247.5,525), -30, letter_texture));
    
//    gives letter C
    
    objects.add(make_shared<Sphere>(glm::dvec3(217.5,307.5,525), -30, letter_texture));
    objects.add(make_shared<Sphere>(glm::dvec3(217.5,247.5,525), -30, letter_texture));
    objects.add(make_shared<Sphere>(glm::dvec3(167.5,347.5,525), -30, letter_texture)); //157.5,337.5
    objects.add(make_shared<Sphere>(glm::dvec3(167.5,207.5,525), -30, letter_texture)); //217.5
    objects.add(make_shared<Sphere>(glm::dvec3(105,187.5,525), -30, letter_texture)); //97.5
    objects.add(make_shared<Sphere>(glm::dvec3(105,367.5,525), -30, letter_texture));
...
void render(const int & x_dimension, const int & y_dimension, Camera camera, hittable_list world){
    ...
    output.open("./project710.ppm", std::ios::out | std::ios::trunc);
...
int main() {
    ...
    const int x_dimension = 1920;
    const int y_dimension = 1040;
    
    auto aspect_ratio = 1.0;
    
    hittable_list world = new_creative();
    auto lookfrom = glm::dvec3(278, 278, -800);
    auto lookat = glm::dvec3(278, 278, 0);
    auto vfov = 40.0;
