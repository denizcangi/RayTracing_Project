//Ray Tracing project Task 6 Lights
...
hittable_list cornell_box_pink() {
    hittable_list objects;

    auto red   = make_shared<lambertian>(glm::dvec3(0.2, 0.4, 0.9));
...
//    objects.add(make_shared<xz_rect>(213, 343, 227, 332, 554, light));
    ...
    objects.add(make_shared<box>(glm::dvec3(130, 0, 65), glm::dvec3(295, 165, 230), make_shared<lambertian>(pertext)));
    objects.add(make_shared<Sphere>(glm::dvec3(350, 100, 295), 100, make_shared<lambertian>(pertext) ));
//    130,0,65
//    350, 100, 295
...
hittable_list cornell_box_blue() {
    hittable_list objects;
...
//    auto material3 = make_shared<metal>(glm::dvec3(0.7, 0.6, 0.5), 0.0);
    ...
    objects.add(make_shared<box>(glm::dvec3(130, 0, 65), glm::dvec3(295, 165, 230), make_shared<lambertian>(pertext)));
    objects.add(make_shared<box>(glm::dvec3(267.5, 0, 212.5), glm::dvec3(432.5, 165, 377.5), make_shared<dielectric>(1.5)));
//    objects.add(make_shared<box>(glm::dvec3(115, 65, 65), glm::dvec3(280, 330, 230), make_shared<lambertian>(pertext)));
    objects.add(make_shared<Sphere>(glm::dvec3(350, 265, 295), 100, make_shared<lambertian>(pertext)));
    objects.add(make_shared<Sphere>(glm::dvec3(212.5, 240, 147.5), -75, make_shared<dielectric>(1.5)));
...
void render(const int & x_dimension, const int & y_dimension, Camera camera, hittable_list world){
    ...
    output.open("./project607.ppm", std::ios::out | std::ios::trunc);
...
//    for the blue cornell box write: cornell_box_blue();
